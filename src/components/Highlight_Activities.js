        ...
        <div class="content-wrapper">
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">  Carousel Headers</li>
          ...
          <section class="content">
            ...
            <div class = "col-md-3" >
				...
				<div class="form-group">
                    ...
                    <TextField id="outlined-basic" label="Title" variant="outlined" onChange={this.onChangetitle}   style={{width: '100%'}}/>
                    
<br />
          <label for="file">Subtitles:</label><br />
          <TextField id="outlined-basic" label="Subtitles" variant="outlined" onChange={this.onChangedescription}   style={{width: '100%'}}/>
          <br />
          <label for="file">Background Image:</label><br />
          <input type="file"/>
