...
handleImageUpload  = () =>{
 ...
 if(files[0] == undefined){
  ...
  handleImageUploadAddInfo = () => {
    const { tag,  tagsLandmarks, tagsPolicies} = this.state;
    console.log('this.state.tagsLandmarks: ', this.state.tagsLandmarks)
    const exercise = { 
      tagsPolicies: this.state.tagsPolicies,
    ...
    axios.post('http://localhost:5000/additional_info/update_tags', exercise)
    .then(res =>{
      window.location.reload()
    })
  }
...
console.log('files[0] :', files[0])
  ...
  render() {
    const { selectedOption, tags, suggestions } = this.state;
    ...
    return (
     ...
     <li onClick={()=> this.getInfoID(info.partition, info.expiration)} key={i} className="treeview active">
              ...
              <Link to="/Highlight_Activities" >  
                  <i class="fa fa-clipboard"></i> <span>Carousel Headers</span>
                  </Link>
              </li>
              <li class="treeview">
              ...
              <Link to="/Hotel_Offers" >  
                  <i class="fa fa-users"></i> <span>Hotel Offers</span></Link>
              </li>
              <li class="treeview">
              <Link to="/Voucher" >  
          ...
          <section class="content">
            ...
            Video Area
				...
				<div class="form-group">
                    ...
                    <img src={this.state.background_image===""?'https://artsmidnorthcoast.com/wp-content/uploads/2014/05/no-image-available-icon-6.png':this.state.background_image} className="displayed-image" width={100} height={100} />
<br />
<label for="title">Main Text:</label> <br />
                    <TextField style={{width: '100%'}} id="outlined-basic" label="Header Text" variant="outlined" value={this.state.Header_Text} onChange={this.onChangeHeader_Text}/>
                    
<br />
<label for="title">Subtext:</label> <br />
                    <TextField style={{width: '100%'}} id="outlined-basic" label="Header Subtext" variant="outlined" value={this.state.Header_Subtext}  onChange={this.onChangeHeader_Subtext}/>
                    
<br />
<label for="title">Video Link:</label> <br />
                    <TextField style={{width: '100%'}} id="outlined-basic" label="Video Link" variant="outlined" value={this.state.link}  onChange={this.onChangelink}/>
...
<img src={this.state.hotel_image===""?'https://artsmidnorthcoast.com/wp-content/uploads/2014/05/no-image-available-icon-6.png':this.state.hotel_image} className="displayed-image" width={100} height={100} style={{backgroundColor: 'gray'}}/>
<br />

<label for="title">Name of Hotel:</label> <br />
                    <TextField style={{width: '100%'}} id="outlined-basic" label="Name of Hotel" variant="outlined" value={this.state.Name_of_Hotel}  onChange={this.onChangeName_of_Hotel}/>
                    
<br />
<label for="title">Address of Hotel:</label> <br />
                    <TextField style={{width: '100%'}} id="outlined-basic" label="Address of Hotel" variant="outlined" value={this.state.address}  onChange={this.onChangeaddress}/>
...
<label for="title">Email of Hotel:</label> <br />
                    <TextField style={{width: '100%'}} id="outlined-basic" label="Email of Hotel" variant="outlined" value={this.state.email}  onChange={this.onChangeemail}/>
                    
<br />
<label for="title">Mobile of Hotel:</label> <br />
                    <TextField style={{width: '100%'}} id="outlined-basic" label="Mobile of Hotel" variant="outlined" value={this.state.mobile}  onChange={this.onChangemobile}/>
<br />
                  ...
                  <label for="title">Telephone of Hotel:</label> <br />
                    <TextField style={{width: '100%'}} id="outlined-basic" label="Telephone of Hotel" variant="outlined" value={this.state.tel_no}  onChange={this.onChangetel_no}/>
                    
<br />
<label for="title">Website of Hotel:</label> <br />
                    <TextField style={{width: '100%'}} id="outlined-basic" label="Website of Hotel" variant="outlined" value={this.state.website}  onChange={this.onChangewebsite}/>
...
<Formik
      ...
      /><br />
                  ...
                  <button type="submit" name="import" class="btn btn-primary btn-sm" onClick={this.handleImageUpload}>&nbsp;&nbsp;Save Hotel Informations&nbsp;&nbsp;</button>
