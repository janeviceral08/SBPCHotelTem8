    ...
    return (
     ...
     <li onClick={()=> this.getInfoID(info.partition, info.expiration)} key={i} className="treeview active">
      ...
      <div class="form-group">
          ...
          <TextField id="outlined-basic" label="Name of Guest" variant="outlined"  onChange={this.onChangename} style={{width: '100%'}}/>
          <br />
<label for="file">Adress:</label><br />
<TextField id="outlined-basic" label="Adress" variant="outlined"  onChange={this.onChangeaddress} style={{width: '100%'}}/>
<br />
