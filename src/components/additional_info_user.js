            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-5">
                      ...
                      <h3 class="text-center mb-4">Room Information</h3>
                    ...
                    <div class="col-md-6 col-lg-5" style={{marginTop: 30}}>
                        <div class="login-wrap p-4 p-md-5">
                      <div class="icon d-flex align-items-center justify-content-center"  >
                       
                      </div>
                      <h3 class="text-center mb-4">Fill In Additional Information</h3>
                      ...
                      <p>{this.state.room_info}</p>
                            <div class="login-form" onSubmit={this.onSubmit}>
